  ...
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left">
        ...
        <div class="title">v v 博 客 网 站</div>
      </div>
      ...
      <div>
        <el-input style="width: 260px; margin-right: 10px" placeholder="请输入关键字搜索" v-model="title" clearable @keyup.enter.native="goSearch"></el-input>
