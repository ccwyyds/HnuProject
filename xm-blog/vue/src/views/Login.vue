<template>
  <div class="container">
    <div style="width: 380px; padding: 50px 30px; background-color: white; border-radius: 5px;">
      <div style="text-align: center; font-size: 24px; margin-bottom: 30px; color: #333">vv博客网站</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="code">
          <div style="display: flex">
            <el-input style="flex: 1" size="medium" v-model="code" @keyup.enter.native="login"></el-input>
            <Identify :identifyCode="identifyCode" @click.native="refreshCode" />
<!--       @keyup.enter.native="refreshCode"     -->
          </div>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      identifyCode: '',
      // 验证码规则
      identifyCodes: '23456789ABCDEFGHGKMNPQRSTUVWXY',
    }
  },
  mounted() {
    this.refreshCode()
